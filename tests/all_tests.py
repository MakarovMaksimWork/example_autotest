...
class Actions():
    ...
    def waiting_for_error(self):
        ...
        try:
            ...
            search = WebDriverWait(self.driver, 30).until(
                EC.element_to_be_clickable((By.XPATH, "/html/body/header/div[1]/div[2]/a[2]/span")))
            search.click()
    ...
    def make_screenshots(self):
        try:
            ...
            self.driver.save_screenshot('C:\\Users\\долбоеб\\PycharmProjects\\example_autotest1\\screen\\' + name_screenshot)
